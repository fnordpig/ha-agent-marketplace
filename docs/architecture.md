...
See `docs/teaching-home-assistant-mcp.md` for the ontology and curriculum that teaches these layers as Home Assistant practice rather than as isolated tools.
